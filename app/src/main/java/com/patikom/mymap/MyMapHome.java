...
public class MyMapHome extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_map_home);
...
//        LatLng lpru = new LatLng(18.234119, 99.4874371);
//        mMap.addMarker(new MarkerOptions()
//                .position(lpru)
//                .title("Marker in LPRU")
//                .snippet("มหาวิทยาลัยราชภัฎลำปาง")
////                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET))
//                .icon(BitmapDescriptorFactory.fromResource(R.drawable.reborn))
//        );
